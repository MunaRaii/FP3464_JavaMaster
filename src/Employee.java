...
class Manager extends Employee {
    ...
    public Manager(String name, int birthYear, double monthlyIncome, int occupationRate, int travelledDays, int clientsBrought, Car car, ContractType contractType) {
        super(name, birthYear, monthlyIncome, occupationRate,"manager", car, contractType);
...
class Tester extends Employee {
    ...
    public Tester(String name, int birthYear, double monthlyIncome, int occupationRate, int bugsSolved, Motorcycle motorcycle, ContractType contractType) {
        super(name, birthYear, monthlyIncome, occupationRate,"tester", motorcycle, contractType);
...
class Programmer extends Employee {
    ...
    public Programmer(String name, int birthYear, double monthlyIncome, int occupationRate, int projectsCompleted, Car car, ContractType contractType) {
        super(name, birthYear, monthlyIncome, occupationRate,"programmer", car, contractType);
